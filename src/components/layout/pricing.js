                ...
                <FlexDiv>
                    <StyledArticle>
                        <div>
                            ...
                            <PriceNumber>0 <span><span>$</span><span primary>Per Month</span></span></PriceNumber>
                        </div>
                        <TryButton primary as="button">Order Now</TryButton>
                    </StyledArticle>
                    <StyledArticle>
                        <div>
                            <TitleCard>STANDART</TitleCard>
                            <SubTitleCard>Organize across all apps by hand</SubTitleCard>
                            <PriceNumber>10 <span><span>$</span><span>Per Month</span></span></PriceNumber>
                        </div>
                        <TryButton primary as="button">Order Now</TryButton>
                    </StyledArticle>
                    <StyledArticle primary>
                        <div>
                            ...
                            <PriceNumber primary>99 <span><span>$</span><span>Per Month</span></span></PriceNumber>
                        </div>
                        <PrimaryButton primary as="button">Order Now</PrimaryButton>
                    </StyledArticle>
                </FlexDiv>
            </StyledSection>
        )
