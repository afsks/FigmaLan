    ...
    return (
      <StyledSection>
        ...
        <StyledDIV>
          ...
          <STYLEDP>Most calendars are designed for teams. Slate is designed for freelancers who want a simple way to plan their schedule.</STYLEDP>
          <Profile>
            <figure>
              <img src={AvatarF} alt="" />
            </figure>
            <div>
              <StyledH6>Organize across</StyledH6>
